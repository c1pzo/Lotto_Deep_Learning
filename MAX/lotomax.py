...
#Read Data    
    ...
    lotto = pd.read_csv('MAXlotto_history.csv', index_col = 'Date')
print(lotto)
...
with strategy.scope():
    ...
    inp8 = Embedding(59, embed_dim)(inp8)
    inp8 = SpatialDropout1D(spatial_dropout_rate)(inp8)

    inp = Concatenate()([inp1, inp2, inp3, inp4, inp5, inp6, inp7, inp8])
