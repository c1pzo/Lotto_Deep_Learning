...
df_tirage = pd.read_csv('LOTTO_MAX.csv', sep = ',', usecols=['num0','num1','num2','num3','num4','num5','num6','num7'])
dtype={'num':str }
...
df_tirage[['num0','num1','num2','num3','num4','num5','num6','num7']].head()
...
df = df[['num0','num1','num2','num3','num4','num5','num6','num7']]
