...
df_tirage = pd.read_csv('LOTTO_649.csv', sep = ',', usecols=['num0','num1','num2','num3','num4','num5','num6'])
dtype={'num':str }
...
df_tirage[['num0','num1','num2','num3','num4','num5','num6']].head()
...
df_tirage.tail()# le dernier tirage devient ici celui du 26
...
df = df[['num0','num1','num2','num3','num4','num5','num6']]
...
df.head()# notre tirage du 26 ici devient le dernier de notre dataset afin de pourvoir organiser les data par historique
...
#prediction
tom = df.tail(window_length).iloc[:,0:7] # 
